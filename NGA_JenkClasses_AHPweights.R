...
# data entered in manually in original set as binary 0/1 to correspond with yes or no
...
NGA_PUB$Prev_DHS_18_state_class[NGA_PUB$Prev_DHS_18_state_range_cat_adjusted >= 23 & NGA_PUB$Prev_DHS_18_state_range_cat_adjusted < 33 ] <- 3
NGA_PUB$Prev_DHS_18_state_class[NGA_PUB$Prev_DHS_18_state_range_cat_adjusted >= 13 & NGA_PUB$Prev_DHS_18_state_range_cat_adjusted < 23 ] <- 2
